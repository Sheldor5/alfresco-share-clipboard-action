package at.pali.alfresco.share.action
{
    ...
    [SWF(backgroundColor="#FFFFFF", width="220", height="22")]
    public class Clipboard extends Sprite
    {
        // embed the icon
        [Embed(source = "/img/clipboard-22.png")]
        ...
        private function init(e:Event = null):void
        {
            ...
            var textFormat:TextFormat = new TextFormat("open-sans-regular", 13, 0x515D6B);
